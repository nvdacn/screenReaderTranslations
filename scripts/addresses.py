...
addresses = {
    ...
    'de': {
        'lang':'German',
        'email': ['Bernd Dorer <bernd_dorer@yahoo.de>', 'David Parduhn <xkill85@gmx.net>', 'Rene Linke <rene.linke@hamburg.de>'],
    },
    'el': {
        'lang': 'Greek',
    ...
    'fa': {
        'lang':'Farsi',
        'email': ['Ali Aslani <aslani.ali@gmail.com>', 'Mohammadreza Rashad <mohammadreza5712@gmail.com>', 'Zahara <zaharaw89@gmail.com>'],
    },
    'fr': {
        'lang':'French',
