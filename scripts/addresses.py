...
addresses = {
    ...
    'hr': {
        'lang': 'Croatian',
        'email': ['Hrvoje Katić <hrvojekatic@gmail.com>', 'Mario Percinic <mario.percinic@gmail.com>'],
    },
    'hu': {
        'lang': 'Hungarian',
        'email': ['Áron Ócsvári <oaron1@gmail.com>'],
    },
    'it': {
        'lang':'Italian',
    ...
    'ja': {
        'lang':'Japanese',
        'email': ['Katsutoshi Tsuji <tsuji-katsutoshi@mitsue.co.jp>'],
    },
    'nb_NO': {
