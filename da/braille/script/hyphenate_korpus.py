...
inFileName = "korpus.txt"
outFileName = "hyphenkorpus.txt"
patternFileName = "hyph_da_DK.dic"

with open(patternFileName) as patternFile:
	patterns = "".join(patternFile.readlines())
patternFile.close()
...
with open(inFileName, "r") as inFile, open (outFileName, "w") as outFile:
	...
	for line in inFile:
		...
		hyphenatedWord = '-'.join(hyphenate_word(word))
		wordsHyphenated = wordsHyphenated + 1
		outFile.write(hyphenatedWord + "\n")
	#endfor

inFile.close()
outFile.close()

print wordsHyphenated, "words hyphenated."
